...
## Link de Acesso
https://projeto-republica.onrender.com/
...
O projeto está hospedado no Render (plano gratuito). Atualmente, os dados de texto (financeiro e moradoras) são persistentes via **MongoDB Atlas**. No entanto, devido ao sistema de arquivos efêmero do Render, os uploads de imagens são temporários. 
*Próxima atualização: Integração com Cloudinary para armazenamento permanente de mídia.*
